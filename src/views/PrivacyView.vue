<template>
  <div id="privacy">
    <section class="hero is-primary">
      <div class="hero-body">
        <div class="container">
          <h1 class="title has-text-centered">Legal</h1>
        </div>
      </div>
    </section>
    ...
    <section class="section">
      <div class="container">
        <h2 class="subtitle">Haftungsbeschränkung</h2>
        ...
        <h2 class="subtitle">Speicherung von IP-Adressen</h2>
        <p>In Verbindung mit Ihrem Zugriff werden auf unseren Servern Daten für Sicherungszwecke gespeichert, die möglicherweise eine Identifizierung zulassen (zum Beispiel IP-Adresse, Datum, Uhrzeit und betrachtete Seiten). Es findet keine personenbezogene Verwertung statt. Die statistische Auswertung anonymisierter Datensätze bleibt vorbehalten.<br/>
        IP-Adressen speichern wir über einen Zeitraum von maximal sieben Tagen. Die Speicherung erfolgt aus Gründen der Datensicherheit, um die Stabilität und die Betriebssicherheit unseres Systems zu gewährleisten.</p><br/>
        <h2 class="subtitle">Links zu anderen Websites</h2>
        <p>Unser Online-Angebot enthält Links zu anderen Websites. Wir haben keinen Einfluss darauf, dass deren Betreiber die Datenschutzbestimmungen einhalten.</p><br/>
        <h2 class="subtitle">Datenschutzerklärung für die Nutzung von Google Analytics</h2>
